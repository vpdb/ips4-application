<?php
/**
 * @brief		Front Navigation Extension: VPDB
...
/**
 * Front Navigation Extension: Vpdb
 */
class _Vpdb extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	/**
	...
	{
		return \IPS\Member::loggedIn()->language()->addToStack('frontnavigation_vpdb');
	}
	...
	{
		return \IPS\Http\Url::internal( "app=vpdb&module=vpdb&controller=home", 'front', 'vpdb' );
	}
