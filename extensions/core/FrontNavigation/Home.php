<?php
/**
 * @brief        Front Navigation Extension: Home
...
/**
 * Front Navigation Extension: Home
 */
class _Home extends \IPS\core\FrontNavigation\FrontNavigationAbstract
{
	/**
	...
	{
		return \IPS\Member::loggedIn()->language()->addToStack('frontnavigation_home');
	}
	...
	{
		return \IPS\Http\Url::internal("app=vpdb&module=vpdb&controller=home");
	}
	...
	public function active()
	{
		return \IPS\Dispatcher::i()->application->directory === 'vpdb'
			...
			and \IPS\Dispatcher::i()->module->key === 'vpdb';
	}
